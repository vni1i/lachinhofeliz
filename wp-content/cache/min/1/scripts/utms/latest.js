    ...
    function r(n) {
        ...
        class c {
            ...
            static getLeadIdFromStorage() {
                var e, t, r, n;
                const l = null !== (r = null !== (t = null !== (e = localStorage.getItem("lead")) && void 0 !== e ? e : localStorage.getItem("lead-google")) && void 0 !== t ? t : localStorage.getItem("lead-kwai")) && void 0 !== r ? r : localStorage.getItem("lead-tiktok");
                if (!l) return null;
                const a = JSON.parse(l);
                return null !== (n = null == a ? void 0 : a._id) && void 0 !== n ? n : null
            }
            ...
            static getUtmParameters() {
                ...
                const g = v("utm_term"),
                    _ = v("keyword");
                let S = g;
                const h = null == g ? void 0 : g.includes(`${c.GOOGLE_KEYWORD_SEPARATOR}${_}`);
                _ && !h && (S = null != g ? `${g}${c.GOOGLE_KEYWORD_SEPARATOR}${_}` : `${c.GOOGLE_KEYWORD_SEPARATOR}${_}`);
                let R = v("utm_content"),
                    A = v("utm_medium"),
                    b = v("utm_campaign"),
                    w = f(v("utm_source"));
                const y = v("gclid"),
                    ...
                    T = v("cid");
                o.isCartpanda ? C.set("cid", T || Math.round(1e11 * Math.random()).toString()) : T && C.set("cid", T), C.set("utm_source", w), C.set("utm_campaign", b), C.set("utm_medium", A), C.set("utm_content", R), C.set("utm_term", S);
                const O = v("CampaignID"),
                    U = v("adSETID"),
                    L = v("CreativeID"),
                    k = v("click_id"),
                    D = v("pixel_id"),
                    $ = e => null != e && "" !== e;
                $(O) && $(U) && $(L) && (w = f("kwai"), b = (null == b ? void 0 : b.includes(O)) ? b : O, A = (null == A ? void 0 : A.includes(U)) ? A : U, R = (null == R ? void 0 : R.includes(L)) ? R : o.preventClickIdsFallback ? L : [L, k, D].join(c.CLICK_ID_SEPARATOR), C.set("utm_source", w), C.set("utm_campaign", b), C.set("utm_medium", A), C.set("utm_content", R)), o.isClickBank ? (C.set("aff_sub1", a.UrlRebuilder.removeSpecialCharacteres(w)), C.set("aff_sub2", a.UrlRebuilder.removeSpecialCharacteres(b).replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("aff_sub3", a.UrlRebuilder.removeSpecialCharacteres(A).replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("aff_sub4", a.UrlRebuilder.removeSpecialCharacteres(null !== (t = null === (e = null == R ? void 0 : R.split(c.CLICK_ID_SEPARATOR)) || void 0 === e ? void 0 : e[0]) && void 0 !== t ? t : "").replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("aff_sub5", a.UrlRebuilder.removeSpecialCharacteres(S)), C.set("unique_aff_sub1", a.UrlRebuilder.removeSpecialCharacteres(w)), C.set("unique_aff_sub2", a.UrlRebuilder.removeSpecialCharacteres(b).replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("unique_aff_sub3", a.UrlRebuilder.removeSpecialCharacteres(A).replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("unique_aff_sub4", a.UrlRebuilder.removeSpecialCharacteres(null !== (n = null === (r = null == R ? void 0 : R.split(c.CLICK_ID_SEPARATOR)) || void 0 === r ? void 0 : r[0]) && void 0 !== n ? n : "").replace(/[a-zA-Z_]/g, "").replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk")), C.set("unique_aff_sub5", a.UrlRebuilder.removeSpecialCharacteres(S)), C.set("tid", 1e15 * Math.random() + "-utmify"), C.set("extclid", 1e15 * Math.random() + "-utmify")) : o.preventSubIds || (C.set("subid", a.UrlRebuilder.removeSpecialCharacteres(w)), C.set("sid2", a.UrlRebuilder.removeSpecialCharacteres(b)), C.set("subid2", a.UrlRebuilder.removeSpecialCharacteres(b)), C.set("subid3", a.UrlRebuilder.removeSpecialCharacteres(A)), C.set("subid4", a.UrlRebuilder.removeSpecialCharacteres(null !== (i = null === (l = null == R ? void 0 : R.split(c.CLICK_ID_SEPARATOR)) || void 0 === l ? void 0 : l[0]) && void 0 !== i ? i : "")), C.set("subid5", a.UrlRebuilder.removeSpecialCharacteres(b)));
                const j = v("src");
                null != j && "" !== j && C.set("src", j);
                const x = [w, b, A, 3 === (null !== (u = null === (s = null == R ? void 0 : R.split(c.CLICK_ID_SEPARATOR)) || void 0 === s ? void 0 : s.length) && void 0 !== u ? u : 0) ? R.split(c.CLICK_ID_SEPARATOR)[0] : R, S],
                    q = x.every((e => "" === e)),
                    M = v("xcod"),
                    K = v("sck");
                if (o.preventXcodSck) M && C.set("xcod", M), K && C.set("sck", K);
                else {
                    const e = p(x, c.UTM_AD_OBJECT_TYPE_SEPARATOR_HOTMART),
                        t = function(e, t, r) {
                        ...
                        }(q ? "" !== M ? M : j : e, 0, c.UTM_AD_OBJECT_TYPE_SEPARATOR_HOTMART);
                    C.set("xcod", t), C.set("sck", t)
                }
                const W = d.get("fbclid");
                null != W && "" !== W && (C.set("fbclid", W), o.preventClickIdsFallback || (R = (null == R ? void 0 : R.includes(c.CLICK_ID_SEPARATOR)) ? R : [R, W, ""].join(c.CLICK_ID_SEPARATOR), C.set("utm_content", R))), null != y && "" !== y && (C.set("gclid", y), o.preventClickIdsFallback || (R = (null == R ? void 0 : R.includes(c.CLICK_ID_SEPARATOR)) ? R : [R, y, ""].join(c.CLICK_ID_SEPARATOR), C.set("utm_content", R))), null != E && "" !== E && C.set("gbraid", E), null != P && "" !== P && C.set("wbraid", P), null != I && "" !== I && (C.set("ttclid", I), o.preventClickIdsFallback || (R = (null == R ? void 0 : R.includes(c.CLICK_ID_SEPARATOR)) ? R : [R, I, ""].join(c.CLICK_ID_SEPARATOR), C.set("utm_content", R)));
                const H = v("utm_id");
                return H && C.set("utm_id", H), (() => {
                    const e = e => null == e || "" === e,
                        t = v("utm_source"),
                        r = v("utm_medium"),
                        n = v("utm_campaign"),
                        ...
                        p = v("src"),
                        f = C.get("fbclid");
                    return e(t) && e(r) && e(n) && e(l) && e(a) && e(m) && e(p) && e(f) && e(o) && e(i) && e(s) && e(u) && e(c) && e(d)
        ...
        function v() {
            ...
            const n = function() {
                var e, t, r, n, l, a, i, s, u, c, d, m, v, p, f, g, _, S, h, R, A, b;
                const {
                    fixShopifyTheme: w
                } = o, y = null !== (t = null === (e = null === window || void 0 === window ? void 0 : window.BOOMR) || void 0 === e ? void 0 : e.themeName) && void 0 !== t ? t : null === (n = null === (r = null === window || void 0 === window ? void 0 : window.Shopify) || void 0 === r ? void 0 : r.theme) || void 0 === n ? void 0 : n.schema_name, E = null !== (l = null == y ? void 0 : y.includes("Dropmeta")) && void 0 !== l && l, P = null !== (a = null == y ? void 0 : y.includes("Warehouse")) && void 0 !== a && a, I = null !== (i = null == y ? void 0 : y.includes("Classic®")) && void 0 !== i && i, C = null !== (s = null == y ? void 0 : y.includes("Tema Vision")) && void 0 !== s && s, T = null !== (u = null == y ? void 0 : y.includes("Waresabino")) && void 0 !== u && u, O = null !== (c = null == y ? void 0 : y.includes("Dawn")) && void 0 !== c && c, U = null !== (d = null == y ? void 0 : y.includes("Vortex")) && void 0 !== d && d, L = null !== (m = null == y ? void 0 : y.includes("Warepro")) && void 0 !== m && m, k = null !== (v = null == y ? void 0 : y.includes("Wareimadigital")) && void 0 !== v && v, D = null !== (p = null == y ? void 0 : y.includes("Mercado Livre")) && void 0 !== p && p, $ = null !== (f = null == y ? void 0 : y.includes("Tema Evolution®")) && void 0 !== f && f, j = null !== (g = null == y ? void 0 : y.includes("Evolution Enterprise")) && void 0 !== g && g, x = null !== (_ = null == y ? void 0 : y.includes("Tema Sabino Vision")) && void 0 !== _ && _, q = null !== (S = null == y ? void 0 : y.includes("Split")) && void 0 !== S && S, M = null !== (h = null == y ? void 0 : y.includes("WART")) && void 0 !== h && h, K = null !== (R = null == y ? void 0 : y.includes("Vogal")) && void 0 !== R && R, W = null !== (A = null == y ? void 0 : y.includes("Aurohra 2.0")) && void 0 !== A && A, H = null !== (b = null == y ? void 0 : y.includes("RAWART")) && void 0 !== b && b;
                return w || E || P || I || C || T || O || U || L || k || D || $ || H || j || x || q || M || K || W
            }();
            e(), t(),
                function() {
                    const e = window.open;
